...
exports.execute = exports.stripProtocolFromUrl = exports.generateRepositoryPath = exports.isNullOrUndefined = exports.extractErrorMessage = void 0;
...
const generateRepositoryPath = (options) => options.sshKey
    ? `git@${options.hostname}:${options.repositoryName}`
    : `https://${`x-access-token:${options.token}`}@${options.hostname}/${options.repositoryName}.git`;
